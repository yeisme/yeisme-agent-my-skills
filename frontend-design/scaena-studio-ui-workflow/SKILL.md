---
name: scaena-studio-ui-workflow
description: Use when designing, implementing, or reviewing Scaena Studio browser UI, including the production cockpit, canonical stage workspaces, subject readiness, shot and media inspection, review, editorial assembly, export, agent surfaces, responsive behavior, and UI evidence.
---

# Scaena Studio UI Workflow
...
- `client/scaena-studio/AGENTS.md` and `client/scaena-studio/app/AGENTS.md`.
- `client/scaena-studio/docs/design/client-ui-spec.md` for shell, components, interactions, tokens, responsive rules, and approved visual direction.
- `client/scaena-studio/docs/design/frontend-architecture-contract-v1.md` for state ownership and dependency boundaries.
...
Use `bun run quality:local` for the local deterministic gate. Browser and integration runs must preserve redacted evidence under `client/scaena-studio/temp/integration-test-runs/<run-id>/`.
