...
- `ai-drama/`: independent first-party AI 做剧 Skills module；以 `ai-drama-router` 为唯一入口，通过 FormatProfile、GenreLens、phase/artifact、最小 ContextPack 和渐进 Skill 解析，按需组合 Format、Story/Character/Showrunner、Scene Writer、Director/Visual、Edit/Sound、Continuity、Critic Panel、Producer 和 Production Orchestrator；不批量安装全部 Skills，也不拥有第二套 canonical state。
