...
a highly camera-savvy adult Korean Instagram influencer with fair skin and an exaggerated figure, wearing pure-and-sultry style.

## Frame

vintage train carriage. accidentally caught while passing the lens, gently squinting.
half-body environmental portrait, 85mm compressed portrait, side shot through plants, extreme negative space.
Foreground: tree leaves. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: low-angle evening backlight. Palette: post-rain gray-blue + moist green. Keep at most 3-4 major color blocks; avoid a multicolored frame.
