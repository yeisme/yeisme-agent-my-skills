...
| “给 Cohors 配一个皇帝总管角色” | `agent-platform-prd` / Cohors owner | `cli/cohors` | 职责与人格分离、tool allowlist、预算、审批、审计 |
...
- **Cohors / runtime owner**：工作角色、工具 allowlist、sandbox、预算、任务和证据；称号不授予权限。
