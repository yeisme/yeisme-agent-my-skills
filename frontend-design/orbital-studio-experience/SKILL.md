...
description: Use when designing, implementing, or reviewing Auctra Studio, Scaena Studio, or Yeisme Workbench creative workspaces that need the Orbital Studio System, bounded Pane layouts, data workspaces, context actions, Agent collaboration, responsive behavior, accessibility, or visual blacklist enforcement without moving canonical domain authority into the client.
---
...
- `Production Orbit`: Scaena Studio ProductionGraph, shot/asset workspaces, preview, review, and delivery gates.
