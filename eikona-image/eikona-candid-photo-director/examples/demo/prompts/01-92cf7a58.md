...
old wooden boat. just sat down, just-woke-up laziness.
shoulder-level close-up, 28mm wide angle, shooting down from the stairs above, lotus leaves forming a natural circular frame.
Foreground: fully defocused lotus flowers. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: fine light flecks through leaves. Palette: deep green + creamy white + skin tone. Keep at most 3-4 major color blocks; avoid a multicolored frame.
