...
一个极具镜头感的韩国 INS 网红，皮肤白皙，身材夸张, wearing 度假风.

## Frame

荷叶下方. 低头整理裙摆, 抬眼看远处.
超近景脸部局部, 50mm自然透视, 人物腰部以下低机位, 大面积水面.
Foreground: 水面反光. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: 穿过树叶形成的细碎光影. Palette: 水蓝+白+灰. Keep at most 3-4 major color blocks; avoid a multicolored frame.
Photography state: 轻微运动模糊.
