...
3. Map all visible interactive regions to both keyboard and mouse behavior.
4. Add or update mouse handlers before visual polish.
5. Make hover, selected, focused, disabled, and active states visually distinct.
6. Remove redundant helper text and command suggestions that compete with the main task.
7. Tune the visual system toward rounded, soft, calm Apple-like utility.
8. Verify with real terminal interaction where possible, not only unit tests.
