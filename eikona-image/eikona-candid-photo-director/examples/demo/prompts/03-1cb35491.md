...
white pavilion. looking sideways into the distance, cold and spaced out.
shoulder-level close-up, 28mm wide angle, pronounced high-angle shot, asymmetric composition.
Foreground: railing. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: afternoon side-backlight. Palette: teal green + off-white + a few pink flowers. Keep at most 3-4 major color blocks; avoid a multicolored frame.
Photography state: partial defocus.
