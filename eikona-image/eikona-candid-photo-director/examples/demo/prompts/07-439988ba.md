...
Foreground: 花瓣. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: 白墙反射光. Palette: 深绿+奶白+肤色. Keep at most 3-4 major color blocks; avoid a multicolored frame.
Photography state: 边缘高光溢出.
