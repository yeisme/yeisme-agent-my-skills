# scaena-storyboard-breakdown-operation-skill Specification

## Purpose
TBD - created by archiving change scaena-storyboard-breakdown-promptrepo-routing-v1. Update Purpose after archive.
## Requirements
