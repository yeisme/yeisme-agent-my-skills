...
- `scaena-studio-ui-workflow`: constrain Scaena Studio browser UI design and implementation with production-stage semantics, subject readiness, dense workspace interaction, state recovery, accessibility, and evidence requirements.
