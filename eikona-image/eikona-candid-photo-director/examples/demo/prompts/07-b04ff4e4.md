...
a highly camera-savvy adult Korean Instagram influencer with fair skin and an exaggerated figure, wearing sweet-and-cool style.

## Frame

convenience-store freezer aisle. just sat down, briefly dazed.
half-body environmental portrait, 35mm environmental portrait, shooting from behind the subject, peeking through gaps in foliage.
Foreground: flower petals. The foreground must intrude naturally into the frame and form a clear occlusion; do not show every element in full.
Light: light bounced off white walls. Palette: deep green + creamy white + skin tone. Keep at most 3-4 major color blocks; avoid a multicolored frame.
Photography state: edge highlight bloom.
